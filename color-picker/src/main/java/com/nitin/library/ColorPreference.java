...
public class ColorPreference extends Preference implements ColorPickerSwatch
    ...
    public ColorPreference(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mStrokeWidth = a.getInt(R.styleable.ColorPreference_cpStrokeWidth, 0);
            mStrokeColor = a.getColor(R.styleable.ColorPreference_cpStrokeColor, 0xff000000);
        } finally {
            a.recycle();
        }
    }
